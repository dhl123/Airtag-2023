...
f=open("./embedding_data/M34_benign.json",'r')
import os
...
f=open("./embedding_data/M341_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
strr=np.load('ground_truth/M3h1_number.npy')
strr=list(strr)
...
predict_labels=second_class('./training_data/training_preprocessed_logs_M3-CVE-2015-3105_windows_py_h1',predict_labels,float(args.thres))
...
start_load_test_time=time.time()
f=open("./embedding_data/M342_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr=np.load('ground_truth/M3h2_number.npy')
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class('./training_data/training_preprocessed_logs_M3-CVE-2015-3105_windows_py_h2',predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
a1=0
...
start_load_test_time=time.time()
f=open("./embedding_data/M343_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr=np.load('ground_truth/M4h1_number.npy')
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class('./training_data/training_preprocessed_logs_M4-CVE_2018_8174_windows_h1',predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
...
start_load_test_time=time.time()
f=open("./embedding_data/M344_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
#print(end_load_test_time-start_load_test_time)
value2=np.array(strr[:-1])
strr=np.load('ground_truth/M4h2_number.npy')
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class('./training_data/training_preprocessed_logs_M4-CVE_2018_8174_windows_h2',predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
a1=0
