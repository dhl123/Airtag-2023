...
f=open("./embedding_data/M56_benign.json",'r')
import os
...
f=open("./embedding_data/M561_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
strr=np.load('ground_truth/M5h1_number.npy')
strr=list(strr)
...
predict_labels=second_class('./training_data/training_preprocessed_logs_M5-CVE-2017-0199_windows_py_h1',predict_labels,float(args.thres))
...
start_load_test_time=time.time()
f=open("./embedding_data/M562_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr=np.load('ground_truth/M5h2_number.npy')
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class('./training_data/training_preprocessed_logs_M5-CVE-2017-0199_windows_py_h2',predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
a1=0
...
start_load_test_time=time.time()
f=open("./embedding_data/M563_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr=np.load('ground_truth/M6h1_number.npy')
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class('./training_data/training_preprocessed_logs_M6-CVE-2017-11882_windows_h1',predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
...
start_load_test_time=time.time()
f=open("./embedding_data/M564_test.json",'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
  strr[i]=strr[i].split('"values"')[1:]
...
#print(end_load_test_time-start_load_test_time)
value2=np.array(strr[:-1])
strr=np.load('ground_truth/M6h2_number.npy')
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
start_cali_time=time.time()
predict_labels=second_class('./training_data/training_preprocessed_logs_M6-CVE-2017-11882_windows_h2',predict_labels)
end_cali_time=time.time()
#print("end cali  time")
#print(end_cali_time-start_cali_time)
a1=0
